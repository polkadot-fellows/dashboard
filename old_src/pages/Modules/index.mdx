...
<div className="note">
  ...
  <p>
    ...
    page](https://polkadot-fellows.github.io/dashboard/salary) to learn more
    about the dispatchable calls, allowed origins and the technical fellowship's
    current usage of `pallet_core_fellowship`.
  </p>
</div>
...
<div className="note">
  ...
  <p>
    ...
    page](https://polkadot-fellows.github.io/dashboard/salary) to learn more
    about the dispatchable calls, allowed origins and the technical fellowship's
    current usage of `pallet_salary`.
  </p>
</div>
