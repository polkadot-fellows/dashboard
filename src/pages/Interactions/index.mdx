...
After every payroll cycle(i.e. 30DAYS) and within the `RegistrationPeriod`(i.e. 15DAYS after the current payroll ) members should make a call to `register` for salary payout.
