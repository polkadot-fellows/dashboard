...
import preimage-promote from "./fellowship-promote-member.png"
import proposal-promote from "./fellowship-promotion-proposal.png"
...
<img className={"adj-img"} src={preimage-promote} alt="preimage" />
...
<img className={"adj-img"} src={proposal-promote} alt="proposal" />
